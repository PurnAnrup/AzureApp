...
namespace AzureApp.Controllers
{
    public class MusicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SongName,SongGenre,Singer")] Music music)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SongName,SongGenre,Singer")] Music music)
        {
            if (id != music.Id)
            {
                return NotFound();
